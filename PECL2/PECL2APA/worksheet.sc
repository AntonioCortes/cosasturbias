...
object worksheet
{
  ...
  }                                               //> preguntarCargarPartida: ()Boolean
  ...
  }                                               //> preguntarQueHacer: (tablero: List[Int], dificultad: Int, puntos: List[Int],
                                                  //|  numVidas: Int)Boolean
  ...
  }                                               //> asignarDificultad: (cargarPartida: Boolean)Int
  ...
  }                                               //> asignarVidas: (cargarPartida: Boolean)Int
  ...
  }                                               //> asignarTablero: (cargarPartida: Boolean, numFilas: Int, numColumnas: Int, n
                                                  //| umColores: Int)List[Int]
  ...
  }                                               //> asignarPuntuacion: (cargarPartida: Boolean)List[Int]
  ...
  //pide al usuario el nivel de dificultad y devuelve el nivel de dificultad introducido
	...
	}                                         //> mostrarPuntos: (puntos: List[Int], dificultad: Int)Unit
	...
	}                                         //> actualizarPuntos: (listaPosiciones: List[Int], puntos: List[Int], color: I
                                                  //| nt, tablero: List[Int], esBomba: Boolean)List[Int]
	...
	}                                         //> actualizarVidas: (tableroOriginal: List[Int], tableroFinal: List[Int], num
                                                  //| Vidas: Int)Int
	...
	}                                         //> terminarJuego: (numVidas: Int, dificultad: Int, puntos: List[Int])Boolean
	...
	}                                         //> comprobarListaPos: (tablero: List[Int], listaPosiciones: List[Int], esBomb
                                                  //| a: Boolean, posicion: Int, numColumnas: Int)List[Int]
  ...
  }                                               //> ejecutar: (tablero: List[Int], posicion: Int, numColumnas: Int, numColores
                                                  //| : Int)List[Int]
  ...
  //"bucle" principal del juego
	...
	}                                         //> juego: (tablero: List[Int], numFilas: Int, numColumnas: Int, dificultad: I
                                                  //| nt, numVidas: Int, numColores: Int, puntos: List[Int])Unit
	...
	def mejorJugada(tablero:List[Int],pos:Int,columna:Int,width:Int,mPuntacion:Int,mPos:Int):Int={
	  ...
	  }                                       //> mejorJugada: (tablero: List[Int], pos: Int, columna: Int, width: Int, mPun
                                                  //| tacion: Int, mPos: Int)Int
	...
	}                                         //> buscarIguales: (tablero: List[Int], posExpandir: List[Int], posEliminar: L
                                                  //| ist[Int], posVisitar: List[Int], width: Int)List[Int]
    ...
    val lposaux4 = dedupe(lposaux3) //Quito iguales y devuelvo
	  return lposaux4
	}                                         //> algoritmoEstrella: (tablero: List[Int], pos: Int, width: Int)List[Int]
	
	def comprobarIgualesArriba(pos:Int,tablero:List[Int],width:Int): Int = {
   if((pos-width>0) && (tablero(pos)==tablero(pos-width))) pos-width
 	  else -1
 	}                                         //> comprobarIgualesArriba: (pos: Int, tablero: List[Int], width: Int)Int
 	...
 	}                                         //> comprobarIgualesAbajo: (pos: Int, tablero: List[Int], width: Int)Int
	...
	def eliminarListasVacias(lista: List[Any]): List[Any] =
  {
  ...
  }                                               //> eliminarListasVacias: (lista: List[Any])List[Any]
	...
	}                                         //> dedupe: [T](elements: List[T])List[T]
  ...
  }                                               //> limpiarLista: (lista: List[Int])List[Int]
	def limpiarLista1000(lista: List[Int]): List[Int] =
  {
  ...
  }                                               //> limpiarLista1000: (lista: List[Int])List[Int]
	...
	}                                         //> eliminarIguales: (tablero: List[Int], lpos: List[Int], primeraI: Boolean)L
                                                  //| ist[Int]
	...
	def getElemento(tablero:List[Int],pos:Int,posActual:Int): Int = {
  	...
  	}                                         //> getElemento: (tablero: List[Int], pos: Int, posActual: Int)Int
  ...
  }                                               //> elementosDiferentes: (lista: List[Int], elementosPorMeter: List[Int])List[
                                                  //| Int]
	
	def añadirElementos(lista: List[Int], elementosPorMeter: List[Int]): List[Int] =
  {
    lista ::: elementosDiferentes(lista, elementosPorMeter)
  }                                               //> añadirElementos: (lista: List[Int], elementosPorMeter: List[Int])List[Int
                                                  //| ]
	...
	}                                         //> elementoNoIgual: (lista1: List[Int], lista2: List[Int])Int
  ...
  }                                               //> elementoEnLista: (lista: List[Int], elemento: Int)Boolean
	
	
	def menor(valor1: Int, valor2: Int): Int = if(valor1 < valor2) valor1 else valor2
                                                  //> menor: (valor1: Int, valor2: Int)Int
  ...
  }                                               //> eliminarValor: (lista: List[Int], valor: Int)List[Int]
  ...
  }                                               //> ordenarLista: (lista: List[Int])List[Int]
  ...
  }                                               //> bajarColumna: (numColores: Int, fila: Int, columna: Int, numColumnas: Int,
                                                  //|  tablero: List[Int])List[Int]
  ...
  }                                               //> averiguarColumna: (posicion: Int, numColumnas: Int)Int
  ...
  }                                               //> averiguarFila: (posicion: Int, numColumnas: Int)Int
  ...
  }                                               //> mismaColumna: (pos1: Int, pos2: Int, numColumnas: Int)Boolean
  ...
  }                                               //> listaColumna: (lista: List[Int], columna: Int, numColumnas: Int)List[Int]
  ...
  }                                               //> separarEnColumnas: (lista: List[Int], numColumnas: Int, columna: Int)List[
                                                  //| Int]
  ...
  }                                               //> bajarCeros: (lista: List[Int], tablero: List[Int], numColumnas: Int, numCo
                                                  //| lores: Int)List[Int]
  ...
  }                                               //> listaCeros: (tablero: List[Int], posicion: Int)List[Int]
  ...
  }                                               //> hayCeros: (lista: List[Int])Boolean
  ...
  }                                               //> animacion: (listaPosiciones: List[Int], tablero: List[Int], numColumnas: I
                                                  //| nt, numColores: Int)List[Int]
  ...
  }                                               //> elegirBomba: (listaPosiciones: List[Int], numColores: Int, tablero: List[I
                                                  //| nt], posicion: Int)Int
  ...
  }                                               //> bajarElemento: (tablero: List[Int], posicion: Int, numColumnas: Int)List[I
                                                  //| nt]

  def esBomba(valor: Int): Boolean = if (valor > 6) true else false
                                                  //> esBomba: (valor: Int)Boolean
  ...
  }                                               //> ponerBomba: (tablero: List[Int], posicion: Int, listaPosiciones: List[Int]
                                                  //| , numColumnas: Int, numColores: Int)List[Int]
  ...
  }                                               //> explosionHorizontal: (tablero: List[Int], fila: Int, tamTablero: Int, numC
                                                  //| olumnas: Int)List[Int]
  ...
  }                                               //> explosionVertical: (tablero: List[Int], columna: Int, tamTablero: Int, num
                                                  //| Columnas: Int)List[Int]
  ...
  }                                               //> explosionTNT: (tablero: List[Int], posSeleccionada: Int, tamTablero: Int, 
                                                  //| numColumnas: Int)List[Int]
  ...
  }                                               //> explotarPuzle: (tablero: List[Int], tipoPuzle: Int)List[Int]
  ...
  }                                               //> explosionPuzle: (tablero: List[Int], color: Int, posActual: Int)List[Int]
  ...
  }                                               //> explotarBomba: (tablero: List[Int], posicion: Int, numColumnas: Int)List[I
                                                  //| nt]
}